...
WpfWindow("Micro Focus MyFlight Sample").WpfTabStrip("WpfTabStrip").Select "SEARCH ORDER" @@ hightlight id_;_1918047816_;_script infofile_;_ZIP::ssf45.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfRadioButton("byNumberRadio").Set @@ hightlight id_;_2019303288_;_script infofile_;_ZIP::ssf46.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("byNumberWatermark").Set a @@ hightlight id_;_1918054152_;_script infofile_;_ZIP::ssf47.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfButton("SEARCH").Click @@ hightlight id_;_1918057416_;_script infofile_;_ZIP::ssf48.xml_;_
